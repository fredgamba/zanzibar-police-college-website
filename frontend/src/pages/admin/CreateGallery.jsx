...
export default function CreateGallery() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.post('admin/gallery/create/', formDataToSend, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
      
      alert('New gallery image successfully!');
      navigate('/admin/gallery');
    } catch (err) {
      console.error('Failed to create gallary');
    ...
    <div className="admin-dashboard">
      ...
      <div className="dashboard-content">
        <div className="page-edit-header">
          ...
          <p>Add a new gallery image to the website</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="news-edit-form">
          ...
          <div className="form-actions">
            ...
            >
              <Save size={18} />
              {saving ? 'Creating...' : 'Create Gallery Image'}
            </button>
